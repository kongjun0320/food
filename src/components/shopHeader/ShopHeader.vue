<template>
    <div class="shop-header">
        ...
        <div @click="toogleShopShow" class="shop-content">
...
<span>约 {{ info.deliveryTime }} 分钟</span>
        ...
        <div class="shop-header-discounts" @click="toogleSupportShow" v-if="info.supports">
...
<span class="mini-tag">品牌</span>
        ...
        <div class="activity-sheet" v-show="supportShow">
            <div class="activity-sheet-content">
                ...
                <ul class="list">
                    <li v-for="(item,index) in info.supports" class="activity-item " :class="activityClass[item.type]" :key="index">
                        <span class="content-tag">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                activityClass: ['activity-red', 'activity-green', 'activity-orange'],
                shopShow: false,
                supportShow: false
            }
        },
